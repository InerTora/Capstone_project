    ...
    <div class="card border-success mb-3"
        ...
        <div class="card-footer bg-transparent border-success text-end">
            ...
            <input class="form-control form-control-lg" type="hidden" name="message"
                value="iDrive Driving Tutorial - <?=$sms_branch->branch_name.'. '.'forwarded a ' .$select->isPending?>  purchase request of <?=ucfirst($select->First_Name).' ' . ucfirst($select->Last_Name)?>" />
            <?php
            }else{

                ?>
            <input class="form-control form-control-lg" type="hidden" name="message"
                value="iDrive Driving Tutorial - <?=$sms_branch->branch_name.'. '.'forwarded a ' .$select->isPending?>  service request of <?=ucfirst($select->First_Name).' ' . ucfirst($select->Last_Name)?>" />
            <?php
            }?>
