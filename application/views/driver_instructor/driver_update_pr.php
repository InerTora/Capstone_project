...
<main class="content">
    <div class="container-fluid">
        ...
        <?php  echo form_open_multipart('PurchaseRequestCtrl/driver_update_pr/'.$select->purchase_request_id,
        ...
        <div class="card border-success mb-3" style="max-width:100%;" id="card">
            ...
            <div class="card-footer bg-transparent border-success text-end ">
                ...
                <a href="<?php echo site_url('PurchaseRequestCtrl/driver_manage_pr'); ?>"><input type="button"
