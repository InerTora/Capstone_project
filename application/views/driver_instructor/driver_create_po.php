...
<main class="content">
    <div class="container-fluid">
        ...
        <?=form_open('PurchaseOrderCtrl/driver_create_po/'.$code->purchase_request_id,  array('onsubmit'=>'return confirm(\'Are you sure you want to create?\')'));?>
        <div class="row  mb-2">
            <div class="col-3">
        ...
        <div class="card border-success mb-3"
            ...
            <div class="card-footer bg-transparent border-success text-end">
                ...
                <a href="<?php echo site_url('PurchaseOrderCtrl/driver_table_po'); ?>"><input type="button" value="Back"
                        class="btn_save"></a>
            </div>
        </div>
