    ...
    <div class="container-fluid">
        ...
        <div class="tab-content" id="ex-with-icons-content">
            <div class="tab-pane fade show active" id="ex-with-icons-tabs-1" role="tabpanel"
                ...
                <?=form_open('PurchaseRequestCtrl/driver_purchase_request/',  array('onsubmit'=>'return confirm(\'Are you sure you want to create?\')'));?>
                ...
                <div class="row">
                    ...
                    <ddiv class="card border-success mb-3 mt-4" style="max-width:100%;" id="card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select mb-1 plate" name="description[]"
                                                style="height:40px:width:90px" id="plate" required>
                                                <option value=""></option>
                        ...
                        <div class="card-footer bg-transparent border-success text-end">
                            ...
                            <a href="<?php echo site_url('PurchaseRequestCtrl/driver_manage_pr'); ?>"><input
                ...
                <input class="form-control form-control-lg" type="hidden" name="contact"
                    value="<?=$sms_branch->contact_no?>" />
                <input class="form-control form-control-lg" type="hidden" name="message"
                    value="iDrive Driving Tutorial - <?=$sms_branch->branch_name?>. <?=$_SESSION['Position'] .' - ' .ucfirst($_SESSION['First_Name']).' '.ucfirst($_SESSION['Last_Name'])?> forwarded a purchase request." />

                <input type="hidden" name="branch_id" value="<?php  echo $_SESSION['branch_id']; ?>">
                <input type="hidden" name="user_id" value="<?php  echo $_SESSION['User_ID']; ?>">
                <input type="hidden" name="isForwarded" value="1">
            ...
            <div class="tab-pane fade" id="ex-with-icons-tabs-2" role="tabpanel" aria-labelledby="ex-with-icons-tab-2">
                ...
                <?=form_open('PurchaseRequestCtrl/driver_purchase_request_sr/',array('onsubmit'=>'return confirm(\'Are you sure you want to create?\')'));?>
                ...
                <ediv class="row">
                    ...
                    <ddiv class="card border-success mb-3 mt-4" style="max-width:100%;" id="card">
                        ...
                        <div class="card-footer bg-transparent border-success text-end">
                            <input type="submit" value="Create" name="btn_create_pr" id="submit_pr" class="btn_save">
                            <a href="<?php echo site_url('PurchaseRequestCtrl/gen_manage_PR'); ?>"><input type="button"
                ...
                <input class="form-control form-control-lg" type="hidden" name="contact"
                    value="<?=$sms_branch->contact_no?>" />
                <input class="form-control form-control-lg" type="hidden" name="message"
                    value="iDrive Driving Tutorial - <?=$sms_branch->branch_name?>-<?=$_SESSION['First_Name'].''.$_SESSION['Last_Name']?>, driving instructor forwarded a service request." />
