...
<main class="content">
    <div class="container-fluid">
        ...
        <?php  echo form_open_multipart('FinanceCtrl/finance_create_PI_sr/'.$get_po_details->PO_ID,
                ...
                <table id="tblProducts" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="pnm form-control" name="item_no[]" value="<?=$row->item_no?>"
                                    style="font-weight:bold; width:100%" readonly />

                                <input type="hidden" name="plate[]" class="form-control" value="0" readonly>
