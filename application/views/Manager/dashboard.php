                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2 ">
                                    ...
                                    <div class="h5 mb-0  text-gray-800" style="font-size:30px;"><?=$count?>
                                    </div>
                                </div>
                                <div class="col-auto">
            ...
            <adiv class="row">
                ...
                <div class="col-xl-3 col-xxl-3">
                    <div class="card flex-fill w-100%">
                        ...
                        <div class="card-body">
                            <a href="<?= site_url('ScheduleCtrl')?>" style="text-decoration: none; color: black">
                ...
                <div class="col-xl-3 col-xxl-3">
                    <div class="card border-success mb-3" style="width: 100%;">
                        ...
                        <div class="card-body">
                            <a href="<?= site_url('ScheduleCtrl')?>" class="list-group-item">
                                <div class="row">
                                    <?php  foreach ($schedule_table_ledger as $row) {?>
