            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h1 class="card-title mb-0 text-center " style="font-size:20px;">
                                <?= $other_branch->branch_name ?>
                            </h1>
                        </div>

                        <?php  echo form_open_multipart('ManagerCtrl/finance_profile/'.$edituser->User_ID,
                array('onsubmit'=>'return confirm(\'Are you sure you want to update?\')'));?>
                        ...
                        <div class="card-footer bg-transparent border-success text-center ">
                            ...
                            <a href="<?= site_url('ManagerCtrl/finance_change_profile/'.$edituser->User_ID);?>">Change
                                Profile
                                Picture</a>
                        </div>
