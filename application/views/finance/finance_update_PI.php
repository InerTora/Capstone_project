...
<main class="content">
    <div class="container-fluid">
        ...
        <?php  echo form_open_multipart('FinanceCtrl/finance_update_PI/'.$view_pi->PI_ID,
                ...
                <table id="tblProducts" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" class="pnm form-control" value="0>" name="item_no[]"
        ...
        <zdiv class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= site_url('FinanceCtrl/upload/'.$view_pi->PI_ID);?>" method="post"
