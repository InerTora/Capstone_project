...
<main class="content">
    <div class="container-fluid">
        ...
        <hr>
        <form action="<?= site_url('FinanceCtrl/gen_approved/'.$view_pi->PV_ID);?>" method="post"
            enctype="multipart/form-data" class="needs-validation" novalidate
            onsubmit="return confirm('Are you sure you want to post?')">
            <div class="row  mb-2">
                <div class="col-3">
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="" value="<?=$view_pi->payment_method?>" class="form-control" readonly
                        style=" font-weight: bold; ">
            ...
            <div class="row">
                <div class="col-3 form-group mb-4">
                    ...
                    <select class="form-select" aria-label="Default select example" style="width:150px" name="status">
                        <option value="<?=$view_pi->isPending?>">Pending</option>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="" value="<?=$view_pi->First_Name.' '.$view_pi->Last_Name?>"
        ...
        <div class="card-body text-success" id="card-body">
            ...
            <div class="form-outline mb-3">
                <textarea class="form-control" id="textAreaExample" rows="1" name="remarks" readonly
                    required><?=$view_pi->remarks?></textarea>
    ...
    <input type="hidden" name="PV_ID" value="<?=$view_pi->PV_ID?>">
