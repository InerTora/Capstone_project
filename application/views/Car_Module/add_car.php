...
<main class="content">
    <div class="container-fluid">
        <div class="card border-success mb-3" style="max-width: 100%;">
            ...
            <?php  echo form_open_multipart('CarCtrl/add_car',
            ...
            <div class="card-body text-success">
                        ...
                        <div class="col">
                            ...
                            <div class="form-outline mb-3 mt-2">
                                <input type="text" class="form-control" style="height:40px" name="plate_no"
                                    value="<?php  echo (set_value('plate_no'));?>" maxlength="16" />
                                <label class="form-label" id="txt">Plate No/MV File</label>
                            </div>
                            ...
                            <div class="form-outline mb-2 mt-2">
                                ...
                                <label class="form-label" id="txt">Brand</label>
                            </div>
                            ...
                            <div class="form-outline mb-2 mt-2">
                                ...
                                <label class="form-label" id="txt">Color</label>
                            </div>
                            ...
                            <div class="form-outline mb-2 mt-2">
                                ...
                                <input type="text" class="form-control" style="height:40px" name="chassis_no"
                                    value="<?php  echo set_value('chassis_no');?>" maxlength="17" />
                                <label class="form-label" id="txt">Chassis No</label>
                            </div>
                ...
                <div class="card-footer bg-transparent border-success text-end ">
                    <input type="submit" class="btn_save" name="addcar" value="Create">
