            ...
            <div class="card border-success mb-3"
                ...
                <div class="card-body">
                    <table class="table my-0 w-100 row-border-none" id="branchtable">
                        ...
                        <tbody>
                            <?php foreach ($table_approved_po as $row) {?>
                            ...
                            <tr>
                                ...
                                ?>
                                    <a href="<?= site_url('PurchaseOrderCtrl/branch_create_PO/'.$row->purchase_request_id);?>"
                    ...
                    ?>
                                    <a href="<?= site_url('PurchaseOrderCtrl/branch_create_po_sr/'.$row->purchase_request_id);?>"
                                        data-mdb-toggle="tooltip" title="Create P.O"><i
                                            class="fa-solid fa-arrow-up-right-from-square fa-lg"></i></a>
