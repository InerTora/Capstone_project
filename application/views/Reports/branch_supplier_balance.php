...
<main class="content">
    <div class="container-fluid">
                ...
                <form action="" method="GET">
                    <div class="row">
                        ...
                        <div class="col-4 mt-3">
                            <div class="form-group">
                                <button type="button" id="branch_btn_balance" class="btn btn-primary">Filter</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <!--Start-->
        <?php  echo form_open_multipart('Export_csv/branch_balance_export',array('onsubmit'=>'return confirm(\'Are you sure you want to export?\')'));?>
        <div class=" row">
            <div class="card border-success mb-3"
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer bg-transparent border-success text-center ">
                        ...
                        <a href="<?=site_url('ReportsCtrl/branch_print_supplier_balance');?>" target='_blank'
