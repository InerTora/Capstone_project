...
<main class="content">
    <h1 class="h2 mb-3  text-dark">Supplier Report List</h1>
            ...
            <form action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-4 mt-3">
                        <div class="form-group">
                            <button type="button" id="branch_filter_report" class="btn btn-primary">Filter</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <sdiv class=" row">
        <div class="card border-success mb-3" style="max-width: 100%; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
            <div class="card-body">
                ...
                <table class="table my-0 w-100 row-border-none" id="report_supplier">
                    ...
                    <tbody>
                        ...
                        foreach($report_supplier as $row)
                        {
                            ?>
            ...
            <div class="card-footer bg-transparent border-success text-center ">
                ...
                <a href="<?=site_url('ReportsCtrl/branch_print_supplier');?>" target='_blank'
