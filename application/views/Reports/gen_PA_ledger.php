...
<main class="content">
            ...
            <form action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-4 mt-3">
                        <div class="form-group">
                            <button type="button" id="gen_pa_filter" class="btn btn-primary">Filter</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <!--Start-->
    <?php  echo form_open_multipart('Export_csv/gen_pa_export',array('onsubmit'=>'return confirm(\'Are you sure you want to export?\')'));?>
    <sdiv class=" row">
        <div class="card border-success mb-3" style="max-width: 100%; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
            ...
            <div class="card-footer bg-transparent border-success text-center ">
                ...
                <a href="<?=site_url('ReportsCtrl/print_pa_ledger');?>" target='_blank'
