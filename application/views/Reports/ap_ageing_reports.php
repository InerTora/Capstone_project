...
<main class="content">
    <div class="container-fluid">
                ...
                <form action="" method="GET">
                    <div class="row">
                        ...
                        <div class="col-4 mt-3">
                            <div class="form-group">
                                <button type="button" id="btn_ageing" class="btn btn-primary">Filter</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <!--Start-->
        <?php  echo form_open_multipart('Export_csv/gen_aging_export',array('onsubmit'=>'return confirm(\'Are you sure you want to export?\')'));?>
        <div class=" row">
            <div class="card border-success mb-3"
                ...
                <div class="card-footer bg-transparent border-success text-center ">
                    ...
                    <a href="<?=site_url('ReportsCtrl/print_ageing_reports');?>" target="_blank"
