...
<div class="container">
    <h1 class="text_head"> <u>Disbursement Voucher</h1>
    <p class="Source">Voucher No: <span class="datafield"><?=$print_voucher->payment_voucher_no?></span></p>
        ...
        <tbody>
            <tr>
                ...
                <td class="data-details">
                    ...
                    <?=$row->description?><span> <?=$row->quantity?></span>
                    <span> <?=$row->unit?></span> <br>
                    <?php }?>
                </td>
