    ...
    <div class="container-fluid">
        ...
        <div class="tab-content" id="ex-with-icons-content">
            <div class="tab-pane fade show active" id="ex-with-icons-tabs-1" role="tabpanel"
                ...
                <?=form_open('PurchaseRequestCtrl/tab/',  array('onsubmit'=>'return confirm(\'Are you sure you want to create?\')'));?>
                    ...
                    <ddiv class="card border-success mb-3 mt-4" style="max-width:100%;" id="card">
                        <div class="card-body text-success mb-3" id="card-body">
                            ...
                            <div class="form-outline">
                                <textarea class="form-control" id="textAreaExample" rows="3" name="purpose"
                                    required></textarea>
            ...
            <div class="tab-pane fade" id="ex-with-icons-tabs-2" role="tabpanel" aria-labelledby="ex-with-icons-tab-2">
                ...
                <?=form_open('PurchaseRequestCtrl/gen_create_SR/',array('onsubmit'=>'return confirm(\'Are you sure you want to create?\')'));?>
