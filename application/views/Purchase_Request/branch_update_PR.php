...
<main class="content">
    <div class="container-fluid">
        ...
        <h1 class="h2 mb-3  text-dark">Update Purchase Request</h1>
        <!--start select catergory-->
        <?php  echo form_open_multipart('PurchaseRequestCtrl/update_branch_pr/'.$select->purchase_request_id,
            ...
            <div class="col-3">
                ...
                <select class="form-select mb-3" aria-label="Default select example" name="supplier" style="height:40px"
                    ...
                    <?php
                                ...
                                ?>
                    <?php foreach ($gasoline_supplier as $row) {?>
        ...
        <div class="card border-success mb-3" style="max-width:100%;" id="card">
                ...
                <table class="table table-bordered" id="tblProducts">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th id="table_style" style="width:20%">Description</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input class="form-control" type="text" name="" value="<?=$row->plate_no?>" readonly>
                                <input class="form-control" type="hidden" name="plate[]" value="<?=$row->car_id?>"
                                    readonly>
                            ...
                            <td>
                                <select class="form-select mb-1 plate" name="description[]" style="height:40px"
                                    id="plate" required>
                                    <option value="<?=$row->description?>" class="invisible"><?=$row->description?>
                                    </option>
                            ...
                            <td>
                                <input class="price form-control" type="number" name="unit_cost[]"
            ...
            <div class="card-footer bg-transparent border-success text-end ">
                ...
                <a href="<?php echo site_url('PurchaseRequestCtrl/branch_manage_PR'); ?>"><input type="button"
